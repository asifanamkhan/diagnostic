...
@section('title', 'Test Commission Report')
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        Test {{ $test->name }}'s Commission Report
        ...
        <div class="main-card mb-3 card">
            {{--<div class="card-header">--}}
                {{--<div class="print-pdf-excel">--}}
                    {{--<a href="{{ route('commission.test.print', $test->id) }}" title="Print" target="_blank">--}}
                        {{--<button class="mb-2 mr-2 btn-icon btn-icon-only btn btn-print">--}}
                            {{--<i class="pe-7s-print btn-icon-wrapper"></i>--}}
                        {{--</button>--}}
                    {{--</a>--}}

                    {{--<a href="{{ route('commission.test.pdf', $test->id) }}" title="PDF" target="_blank" class="editable-link">--}}
                        {{--<button class="mb-2 mr-2 btn-icon btn-icon-only btn btn-pdf">--}}
                            {{--<i class="fa fa-file-pdf-o btn-icon-wrapper"></i>--}}
                        {{--</button>--}}
                    {{--</a>--}}
                    {{--<a href="{{ route('commission.test.excel', $test->id) }}" title="Excel" target="_blank" class="editable-link">--}}
